...
PUT file:///Users/loonycorn/Desktop/AdvancedSnowflake/iowa_sales.csv @SALES_STAGE;

LIST @SALES_STAGE;

COPY INTO IOWA_SALES 
FROM @SALES_STAGE/iowa_sales.csv.gz
